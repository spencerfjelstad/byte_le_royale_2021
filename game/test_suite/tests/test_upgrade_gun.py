...
class TestUpgradesentryGun(unittest.TestCase):
    ...
    def test_upgrade_one_level(self):
        ...
        self.assertTrue(isinstance(self.myPlayer.truck.body, SentryGun))
    ...
    def test_upgrade_beyond_allowable(self):
        ...
        expectedCash = self.myPlayer.truck.money - helpers.addTogetherDictValues(stats.GameStats.costs_and_effectiveness[ObjectType.sentryGun]['cost'])
        self.actionCont.upgrade_level(self.myPlayer, ObjectType.sentryGun)
        self.actionCont.upgrade_level(self.myPlayer, ObjectType.sentryGun)
        self.actionCont.upgrade_level(self.myPlayer, ObjectType.sentryGun)
        self.actionCont.upgrade_level(self.myPlayer, ObjectType.sentryGun)
        self.actionCont.upgrade_level(self.myPlayer, ObjectType.sentryGun)
        self.assertEqual(self.myPlayer.truck.body.level, SentryGunLevel.level_three)

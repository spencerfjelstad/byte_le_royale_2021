...
-- Started on 2021-10-23 17:24:17
...
--
-- TOC entry 2928 (class 2604 OID 17384)
...
--
-- TOC entry 2924 (class 2604 OID 17306)
...
--
-- TOC entry 2921 (class 2604 OID 17280)
...
--
-- TOC entry 2926 (class 2604 OID 17342)
...
--
-- TOC entry 2917 (class 2604 OID 17259)
...
--
-- TOC entry 3087 (class 0 OID 17290)
-- Dependencies: 206
...
9	Wow what an awesome and large code file
10	from game.client.user_client import UserClient\nfrom game.common.enums import *\n\n\nclass Client(UserClient):\n    # Variables and info you want to save between turns go here\n    def __init__(self):\n        super().__init__()\n        self.turn = 0\n\n    def team_name(self):\n        """\n        Allows the team to set a team name.\n        :return: Your team name\n        """\n        return 'Team Name'\n\n    # This is where your AI will decide what to do\n    def take_turn(self, turn, actions, world, truck, time):\n        """\n        This is where your AI will decide what to do.\n        :param turn:        The current turn of the game.\n        :param actions:     This is the actions object that you will add effort allocations or decrees to.\n        :param world:       Generic world information\n        """\n        self.turn += 1\n\n        chosen_upgrade = self.select_upgrade(actions, truck)\n        # If there is not an active contract get one\n        if(truck.active_contract is None):\n            #print("Select")\n            chosen_contract = self.select_new_contract(actions, truck)\n            actions.set_action(ActionType.select_contract, chosen_contract)\n        # Buy gas if below 20% and there is enough money to fill tank to full at max gas price\n        elif(truck.body.current_gas < .20 and truck.money > 100*truck.active_contract.game_map.current_node.gas_price):\n            #print("Gas")\n            actions.set_action(ActionType.buy_gas)\n        # If health is below max and have enough money to fully repair do so\n        elif truck.health < 100 and truck.money > 1000:\n            #print("Heal")\n            actions.set_action(ActionType.repair)\n        elif chosen_upgrade is not None:\n            #print("Upgrade")\n            actions.set_action(ActionType.upgrade, chosen_upgrade)\n        elif(truck.active_contract.game_map.current_node.next_node is not None):\n            # Move to next node\n            # Road can be selected by passing the index or road object\n            #print("Move")\n            road = self.select_new_route(actions, truck)\n            actions.set_action(ActionType.select_route, road)\n\n        if self.turn == 69 or self.turn == 420:\n            print("Funny Number!")\n        \n        pass\n\n    # These methods are not necessary, so feel free to modify or replace\n    def select_new_contract(self, actions, truck):\n        selected_contract = truck.contract_list[0]\n        for contract in truck.contract_list:\n            if contract.difficulty == ContractDifficulty.easy:\n                selected_contract = contract\n        return selected_contract\n\n    # Contract can be selected by passing the index or contract object\n    def select_upgrade(self, actions, truck):\n        target_body_upgrade = ObjectType.tank\n        target_addons_upgrade = ObjectType.rabbitFoot\n        if truck.body.level < 3 and truck.get_cost_of_upgrade(target_body_upgrade) < truck.money:\n            chosen_upgrade = target_body_upgrade\n        elif truck.addons.level < 3 and truck.get_cost_of_upgrade(target_addons_upgrade) < truck.money:\n            chosen_upgrade = target_addons_upgrade\n        else:\n            chosen_upgrade = None\n        return chosen_upgrade\n    \n    # Road can be selected by passing the index or road object\n    def select_new_route(self, actions, truck):\n        roads = truck.active_contract.game_map.current_node.roads\n        return roads[0]\n
\.


--
4	113	0	67	2021-10-18 14:21:11.965654
6	114	0	67	2021-10-18 14:21:11.965654
8	115	16	67	2021-10-18 14:21:11.965654
4	116	0	67	2021-10-18 14:21:11.965654
6	117	0	67	2021-10-18 14:21:11.965654
8	118	44	67	2021-10-18 14:21:11.965654
4	119	0	67	2021-10-18 14:21:11.965654
6	120	0	67	2021-10-18 14:21:11.965654
8	121	280	67	2021-10-18 14:21:11.965654
4	122	0	67	2021-10-18 14:21:11.965654
6	123	0	67	2021-10-18 14:21:11.965654
8	124	50	67	2021-10-18 14:21:11.965654
6	125	0	68	2021-10-23 17:22:03.621493
6	126	0	69	2021-10-23 17:22:28.022663
9	127	0	69	2021-10-23 17:22:28.936794
10	128	40	69	2021-10-23 17:22:30.430237
6	129	0	69	2021-10-23 17:22:31.275195
9	130	0	69	2021-10-23 17:22:32.089629
10	131	850	69	2021-10-23 17:22:43.067177
6	132	0	69	2021-10-23 17:22:44.146196
9	133	0	69	2021-10-23 17:22:44.960217
10	134	40	69	2021-10-23 17:22:46.76282
6	135	0	69	2021-10-23 17:22:47.66851
9	136	0	69	2021-10-23 17:22:48.469452
10	137	261	69	2021-10-23 17:22:51.539716
6	138	0	69	2021-10-23 17:22:52.379169
9	139	0	69	2021-10-23 17:22:53.180349
10	140	66	69	2021-10-23 17:22:55.308049
\.


--
-- TOC entry 3086 (class 0 OID 17277)
-- Dependencies: 205
...
9f50ba24-5f23-47ad-850d-b9e85fca1a98	9	f	2021-10-19 18:23:54.284842
69b5d2a3-a383-48b1-a27c-a82e75429595	10	f	2021-10-23 17:21:30.057581
\.


--
-- TOC entry 3084 (class 0 OID 17263)
-- Dependencies: 203
...
--
-- TOC entry 3092 (class 0 OID 17339)
-- Dependencies: 211
...
--
-- TOC entry 3083 (class 0 OID 17256)
-- Dependencies: 202
...
SELECT pg_catalog.setval('public.group_run_group_run_id_seq', 69, true);
...
SELECT pg_catalog.setval('public.run_runid_seq', 140, true);
...
SELECT pg_catalog.setval('public.submission_submissionid_seq', 10, true);
...
--
-- TOC entry 2943 (class 2606 OID 17387)
...
--
-- TOC entry 2939 (class 2606 OID 17308)
...
--
-- TOC entry 2937 (class 2606 OID 17284)
...
--
-- TOC entry 2933 (class 2606 OID 17269)
...
--
-- TOC entry 2935 (class 2606 OID 17353)
...
--
-- TOC entry 2941 (class 2606 OID 17345)
...
--
-- TOC entry 2931 (class 2606 OID 17262)
...
--
-- TOC entry 2947 (class 2606 OID 17296)
...
--
-- TOC entry 2951 (class 2606 OID 17530)
...
--
-- TOC entry 2950 (class 2606 OID 17320)
...
--
-- TOC entry 2949 (class 2606 OID 17388)
...
--
-- TOC entry 2948 (class 2606 OID 17309)
...
--
-- TOC entry 2946 (class 2606 OID 17285)
...
--
-- TOC entry 2945 (class 2606 OID 17346)
...
--
-- TOC entry 2944 (class 2606 OID 17270)
...
-- Completed on 2021-10-23 17:24:18

...
class Client(UserClient):
    ...
    def take_turn(self, turn, actions, world, truck, time):
        ...
        elif ActionType.repair != self.prevAction and ((truck.health < 70 and truck.map.current_node.repair_price < truck.map.current_node.next_node.repair_price * 1.5) or truck.health < 65):
